...
CRGB enforce_brightness(CRGB input)
{
   ...
   * This takes a CRGB in, reduces the brightness by "bright" variable
...
=======
	...
	store_current(input);
>>>>>>> d59049e8fc798356d0569a352fb13f4e2d7b6ac8
}
...
uint8_t Lixie::get_numdigits() const { return NumDigits; }
...
void Lixie::white_balance(CRGB c_adj) { controller->setTemperature(c_adj); }
